...
namespace Boostrapper.Editor
{
    [InitializeOnLoad]
    public class LoadBootstrapper
    {
        public const string BOOTSTRAP_TOGGLE = "Bootstrapper/Load Bootstrapper";
        public const string AUTO_BOOTSTRAP_CURRENT_SCENE_TOGGLE = "Bootstrapper/Auto Bootstrap Open Scene";
        public const string AUTO_BOOTSTRAP_EDITOR_SCENE = "Bootstrapper/LastLoadedEditorScene";

        static LoadBootstrapper()
        {
